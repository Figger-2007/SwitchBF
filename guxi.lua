local library = {
    ...
    colors = {
        main = Color3.fromHex('D33352'),--  FF0000
        background = Color3.fromRGB(0, 0, 0),
        outerBorder = Color3.fromRGB(0, 0, 0),
        innerBorder = Color3.fromHex('571A18'), --  280035
        topGradient = Color3.fromRGB(0, 0, 0),
        bottomGradient = Color3.fromRGB(0, 0, 0),
        sectionBackground = Color3.fromHex('0d0c0d'),
        section = Color3.fromHex('D33352'), -- 
        otherElementText = Color3.fromHex('D69789'), 
        elementText = Color3.fromHex('BFBFBF'),
        elementBorder = Color3.fromHex('363636'), -- 3C0062 1E0030
    ...
    --[[
        colors = {
        main = Color3.fromHex('FC92FB'),--  FF0000
        background = Color3.fromRGB(0, 0, 0),
        outerBorder = Color3.fromRGB(0, 0, 0),
        innerBorder = Color3.fromHex('593459'), --  280035
        topGradient = Color3.fromRGB(0, 0, 0),
        bottomGradient = Color3.fromRGB(0, 0, 0),
        sectionBackground = Color3.fromHex('140313'),
        section = Color3.fromHex('FC92FB'), -- 
        otherElementText = Color3.fromHex('871680'), 
        elementText = Color3.fromHex('BFBFBF'),
        elementBorder = Color3.fromHex('573571'), -- 3C0062 1E0030
        selectedOption = Color3.fromHex('003005'), -- 1E0030 3E0000
        unselectedOption = Color3.fromHex('003005'),
        hoveredOptionTop = Color3.fromHex('003005'),
        unhoveredOptionTop = Color3.fromHex('003005'),
    ...
    colors = {
        ...
        background = Color3.fromRGB(0, 0, 0),
        outerBorder = Color3.fromRGB(0, 0, 0),
        innerBorder = Color3.fromHex('320729'), --  280035
        topGradient = Color3.fromRGB(0, 0, 0),
        bottomGradient = Color3.fromRGB(0, 0, 0),
        sectionBackground = Color3.fromHex('140313'),
        section = Color3.fromHex('D33352'), -- 
        otherElementText = Color3.fromHex('D29EE3'), 
        elementText = Color3.fromHex('BFBFBF'),
        elementBorder = Color3.fromHex('573571'), -- 3C0062 1E0030
        selectedOption = Color3.fromHex('003005'), -- 1E0030 3E0000
        unselectedOption = Color3.fromHex('003005'),
